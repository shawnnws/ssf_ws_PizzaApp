...
public class Order implements Serializable {
    ...
    // Returning info from other Classes here to consolidate Order information.
    ...
    public static Order create(String jsonStr){
        ...
        // Instantiate Order object with Pizza and Delivery objects passed in as parameters
    ...
    // Use a filter to build the JSON object
