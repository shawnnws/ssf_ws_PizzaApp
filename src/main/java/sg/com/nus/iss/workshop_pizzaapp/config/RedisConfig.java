package sg.com.nus.iss.workshop_pizzaapp.config;
...
public class RedisConfig {
    ...
    // For Bean, we define a qualifier when autowiring to prevent autowiring the wrong class that might be under another package/library
    @Bean("pizza")
    @Scope("singleton")
